...
router.post('/', authenticateToken, checkPermission(['superadmin', 'admin']), planController.createPlan);
router.put('/:id', authenticateToken, accessControl(), checkPermission(['superadmin', 'admin']), planController.updatePlan);
router.delete('/:id', authenticateToken, accessControl(), checkPermission(['superadmin', 'admin']), planController.deletePlan);
